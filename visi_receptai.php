...
if (loggedIn($where)) {
	...
	if ( 
		...
		*/
        ...
        $supply = "<table class=\"table table-bordered\" style=\"width:20%; text-align: center;\">";
        $supply .= "<tr align='center'><td align='center'><b>Produktas</b></td><td align='center'><b>Kiekis</b></td></tr>";
        $current = $recipe[0];
